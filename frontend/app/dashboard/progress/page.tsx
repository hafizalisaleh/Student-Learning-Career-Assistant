...
import { KnowledgeEvolutionPanel } from '@/components/progress/knowledge-evolution-panel';
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      {evolutionData && evolutionData.total_concepts > 0 && (
        <KnowledgeEvolutionPanel evolutionData={evolutionData} onRefresh={loadAnalytics} />
      )}
